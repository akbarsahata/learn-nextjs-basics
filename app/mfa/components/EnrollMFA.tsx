    ...
    return (
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600">
          Add an extra layer of security to your account by enabling 2FA with an
          authenticator app.
        </p>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-gray-600 space-y-2">
        ...
        <p>
          <strong>Step 2:</strong> Scan the QR code below or manually enter the
          secret key.
        </p>
        <p>
          <strong>Step 3:</strong> Enter the 6-digit code from your
          authenticator app.
        </p>
      </div>
